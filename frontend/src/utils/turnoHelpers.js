...
export function getTurnoProps(turno) {
  ...
  if (t === "l.med" || t === "medica")
    return {
      clase: "text-xs text-black font-bold bg-yellow-300",
      contenido: "L.Med",
    };

  if (t === "licencia" || t === "l" || t === "reglamentaria")
    return {
      clase: "text-xs text-white bg-green-600",
      contenido: "L",
    };
  ...
  if (t === "t-1")
    return {
      clase: "text-xs text-violet-900 bg-violet-300 font-semibold",
      contenido: turno,
    };
